-- =====================================================
-- Aidoctor - Safe Supabase Migration
-- Sadece eksik tabloları oluşturur, mevcut olanları etkilemez
-- =====================================================
...
-- =====================================================
-- INDEXES (CREATE IF NOT EXISTS - PostgreSQL 9.5+)
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_lab_results_ordered_at ON public.lab_results(ordered_at DESC);
CREATE INDEX IF NOT EXISTS idx_lab_results_category ON public.lab_results(category);

CREATE INDEX IF NOT EXISTS idx_imaging_results_patient_id ON public.imaging_results(patient_id);
CREATE INDEX IF NOT EXISTS idx_imaging_results_status ON public.imaging_results(status);
CREATE INDEX IF NOT EXISTS idx_imaging_results_ordered_at ON public.imaging_results(ordered_at DESC);

CREATE INDEX IF NOT EXISTS idx_chat_messages_patient_id ON public.chat_messages(patient_id);
CREATE INDEX IF NOT EXISTS idx_chat_messages_created_at ON public.chat_messages(created_at DESC);

CREATE INDEX IF NOT EXISTS idx_ai_analysis_patient_id ON public.ai_analysis(patient_id);
...
-- Apply update triggers (DROP IF EXISTS first)
...
DROP TRIGGER IF EXISTS update_vital_signs_updated_at ON public.vital_signs;
...
DROP TRIGGER IF EXISTS update_imaging_results_updated_at ON public.imaging_results;
